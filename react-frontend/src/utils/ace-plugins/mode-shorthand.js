// Re-work to use this pattern: https://github.com/securingsincity/react-ace/issues/126#issuecomment-1001363119
...
// export default class ShorthandMode extends window.ace.acequire('ace/mode/text').Mode {
//   constructor() {
//     super();
